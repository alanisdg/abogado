...
<link rel="stylesheet" href="{{ asset('backend/css/assets/components.min.css') }}" rel="stylesheet" type="text/css"/>
{{--<link rel="stylesheet" href="{{ asset('backend/css/assets/themes/dark-layout.min.css') }}" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="{{ asset('backend/css/assets/themes/bordered-layout.min.css') }}" rel="stylesheet" type="text/css"/>--}}
{{--<link rel="stylesheet" href="{{ asset('backend/css/assets/themes/semi-dark-layout.min.css') }}" rel="stylesheet" type="text/css"/>--}}
<link rel="stylesheet" href="{{ asset('backend/css/assets/core/menu/menu-types/vertical-menu.min.css') }}" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="{{ asset('backend/css/assets/tables/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="{{ asset('backend/css/assets/tables/responsive.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
{{--<link rel="stylesheet" href="{{ asset('backend/css/assets/tables/buttons.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="{{ asset('backend/css/assets/tables/rowGroup.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>--}}
<link rel="stylesheet" href="{{ asset('backend/css/assets/pages/ui-feather.min.css') }}" rel="stylesheet" type="text/css"/>
