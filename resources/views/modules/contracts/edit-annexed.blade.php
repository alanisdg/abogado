...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Editar Anexo</h4>
        </div>
        <div class="card-body">
                {!! Form::open(['url' => 'contract/update', 'autocomplete' => 'off', 'id' => 'form', 'class' => 'form form-vertical', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <input type="hidden" value="annexed" name="annexed">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a class="btn btn-danger waves-effect waves-float waves-light" href="{{ url("list-contracts/annexes/".$row->number_contract) }}" id="cancel"><i data-feather='corner-up-left'></i> Regresar</a>
