...
<body>
    ...
    <p style="margin-top: 20px;">
       <strong>1. </strong>Depósito Bancario en la cuenta (DATOS DE LA CUENTA). En este caso el cliente deberá enviar el comprobante de pago a la casilla de correo señala para estos efectos. Si quien deposita es un tercero distinto del cliente, en dicho correo se deberá indicar RUN y nombre completo del cliente respecto del cual se hizo el pago. El cliente entiende que, de no proporcionarse dicha información el pago no podrá ser imputado y descontado como mensualidad de su contrato hasta que se proporcione los antecedentes antes mencionados.
    </p>

    <p style="margin-top: 20px;">
        <strong>2. </strong>Transferencia Electrónica (DATOS DE LA CUENTA). En este caso el cliente deberá enviar el comprobante de pago a la casilla de correo indicada para tales efectos. Si quien realiza la transferencia es un tercero distinto del cliente, en dicho correo se deberá indicar RUN y nombre completo del cliente respecto del cual se hizo el pago. El cliente entiende que, de no proporcionarse dicha información el pago no podrá ser imputado y descontado como mensualidad de su contrato hasta que se proporcione los antecedentes antes mencionados.
    </p>
