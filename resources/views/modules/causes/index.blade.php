        ...
        $(document).ready(function (){
            ...
            var tableInit = $('#tableCrud').DataTable({
                ...
                createdRow: function(row, data, dataIndex) {
                    ...
                    tr += 			'<img src="../backend/images/assets/homework.svg" style="width: 20%">'
                    tr += 		'</a>'
                    tr += 		'<a id="contacts__btnViewCausas" title="Ver Causas" onclick="getCausas('+data.id+')" class="" style="margin-left:8px;">'
                    tr += 			'<img src="../backend/images/assets/zoom.svg" style="width: 20%">'
                    tr += 		'</a>'
                    tr += 	'</div>'
                    tr += '</td>'
                    $(row).html(tr)
